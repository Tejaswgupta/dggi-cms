...
CREATE TABLE IF NOT EXISTS "public"."dggi_closure_records" (
    ...
    "file_number" "text",
    "taxpayer_name" "text",
    "closure_report_no" "text",
    "closure_date" "date",
    "closure_under_section" "text",
...
ALTER TABLE ONLY "public"."dggi_closure_records"
    ADD CONSTRAINT "dggi_closure_records_sio_fkey" FOREIGN KEY ("sio") REFERENCES "public"."votum_users"("id") ON DELETE SET NULL;
