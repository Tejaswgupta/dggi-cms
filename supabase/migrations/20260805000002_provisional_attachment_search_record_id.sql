-- Extend the provisional attachment batch page RPC to also search by record_id
-- and attachment_batch_id so that dashboard deep-links (filter=PAR/001/26-27) work.
