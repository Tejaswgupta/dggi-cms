...
const COLUMNS: RegisterColumn[] = [
  ...
  { key: "detection_amount", label: "Detection (₹)", type: "text", width: "150px" },
  { key: "recovery_itc", label: "Recovery ITC (₹)", type: "text", width: "160px" },
  { key: "recovery_cash", label: "Recovery Cash (₹)", type: "text", width: "160px" },
