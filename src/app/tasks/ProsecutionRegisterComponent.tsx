...
const ARREST_COLS: RegisterColumn[] = [
  ...
  { key: "status_of_person", label: "Status", type: "select", options: ["On Bail", "In Custody", "Absconding", "Deceased"], allowOther: true, width: "130px" },
  ...
  { key: "prosecution_complaint_status", label: "Prosecution Status", type: "select", options: ["Filed", "Not Filed", "Pending Sanction"], allowOther: true, width: "160px" },
