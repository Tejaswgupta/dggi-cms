...
const RECORD_PREFIX = REGISTER_PREFIXES.MODUS_OPERANDI;
const TABLE_NAME = "dggi_modus_operandi_records";

interface ModusOperandiRecord {
  id: string;
  record_id: string;
  linked_case_id: string;
  brief_facts: string;
  methodology: string;
  gst_law_provision: string;
  cases_booked_amounts: string;
  widespread_evasion: string;
  board_clarification: string;
...
const COLUMNS: RegisterColumn[] = [
  ...
  { key: "brief_facts", label: "Brief Facts & How Detected", type: "text", width: "300px" },
  { key: "methodology", label: "Methodology Employed", type: "text", width: "280px" },
  { key: "gst_law_provision", label: "Relevant GST Law Provision", type: "text", width: "260px" },
  { key: "cases_booked_amounts", label: "Cases Booked & Amounts", type: "text", width: "220px" },
  { key: "widespread_evasion", label: "Widespread Evasion Details", type: "text", width: "240px" },
  { key: "board_clarification", label: "Clarification by Board", type: "text", width: "220px" },
  { key: "court_advance_rulings", label: "Court / Advance Rulings", type: "text", width: "220px" },
  { key: "other_info", label: "Other Relevant Info", type: "text", width: "240px" },
...
const ModusOperandiRegisterComponent = () => {
  ...
  const [dialogDraft, setDialogDraft] = useState<Partial<ModusOperandiRecord>>({});
      ...
      <div className="px-3 sm:px-6 space-y-5">
        <div className="rounded-2xl border border-[#EDEDEA] bg-white shadow-none px-5 py-4">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              <h1 className="text-xl font-medium text-[#1a1a1a]">Modus Operandi Circular Register</h1>
        ...
        <div className="rounded-2xl border border-[#EDEDEA] bg-white shadow-none px-4 py-3">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="relative flex items-center">
              ...
              <Input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Search facts, methodology…" className="h-9 pl-8 pr-3 min-w-[240px] border-[#EDEDEA] text-base rounded-lg" />
            </div>
            ...
            <Table>
              ...
              <TableBody>
                ...
                {tableRecords.length === 0 && (
                  <TableRow><TableCell colSpan={TOTAL_COLS} className="py-12 text-center text-base text-[#9a9a96]">No modus operandi records found.</TableCell></TableRow>
                )}
              </TableBody>
            </Table>
          </div>
...
export default ModusOperandiRegisterComponent;
