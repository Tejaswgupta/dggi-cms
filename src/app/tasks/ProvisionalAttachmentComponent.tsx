...
const COLUMNS: RegisterColumn[] = [
  ...
  { key: "expected_liability", label: "Expected Liability (Cr.)", type: "text", width: "160px" },
  ...
  { key: "value_immovable", label: "Value – Immovable Property (Cr.)", type: "text", width: "200px" },
  { key: "value_movable", label: "Value – Movable Property (Cr.)", type: "text", width: "190px" },
  { key: "value_shares", label: "Value – Share/Insurance/FD (Cr.)", type: "text", width: "200px" },
  { key: "value_bank", label: "Value – Bank A/c (Cr.)", type: "text", width: "160px" },
  { key: "value_third_party", label: "Value – Third Party (Cr.)", type: "text", width: "170px" },
  { key: "value_others", label: "Value – Others (Cr.)", type: "text", width: "150px" },
  { key: "value_total", label: "Value – Total (Cr.)", type: "text", width: "150px" },
